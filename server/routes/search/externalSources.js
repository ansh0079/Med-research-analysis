...
/**
 * External evidence-source proxy routes — extracted from
 * `server/routes/search.js` to reduce the god-file. Each route proxies a
 * single external API (PubMed, Semantic Scholar, OpenAlex, Crossref, MeSH)
 * with caching and search-event logging.
 */
 ...
 * @param {object} deps.proxy - buildProxyService() result
 * @param {function} deps.rateLimit
 */
function registerExternalSourceRoutes(app, { db, cache, proxy, rateLimit }) {
