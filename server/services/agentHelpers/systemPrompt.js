...
const { TEACHING_STRATEGY_DIRECTIVES } = require('./constants');
...
function buildAgentSystemPrompt(topicKnowledge, currentArticles, guidelines = [], userContext = null, crossTopicBridges = [], retrieval = {}, { teachingStrategy = null, agentMistakes = [], comorbidGrounding = '' } = {}) {
    ...
    if (userContext) {
        ...
        const stageSpecifics = {
            ...
            // 'specialist' is normalised to 'clinician' at normaliseAgentStage(), handled by the clinician branch below.
