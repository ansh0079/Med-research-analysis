...
const GUIDELINE_KIND_RE = /\b(clinical guidelines?|practice guideline|practice parameter|guideline update|who guideline|international consensus|expert consensus|consensus(?: guidelines?)?|evidence-based guideline|appropriate use recommendations?|aur|systematic review.{0,4}guideline|meta-analysis.{0,4}guideline|landmark trial.{0,4}guideline)\b/i;
