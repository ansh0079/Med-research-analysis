...
const GUIDELINE_KIND_RE = /\b(clinical guidelines?|practice guideline|guideline update|international consensus|consensus(?: guidelines?)?|evidence-based guideline|appropriate use recommendations?|aur|systematic review.{0,2}guideline)\b/i;
