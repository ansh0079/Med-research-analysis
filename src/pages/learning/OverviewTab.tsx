...
import type { LearningDashboard, LearningInsight, CalibrationSummary, UserTopicMemory } from '@types';
import type { PracticeAlert, JudgementData } from './useLearningDashboardData';
...
import { ForYouPanel } from '@components/learning/LearningDashboardPanels';
...
interface OverviewTabProps {
  ...
  dueCount: number;
  drillTopic: (topic: string, studyRunId?: number) => void;
  caseOnTopic: (topic: string) => void;
  handleInsightAction: (insight: LearningInsight) => void;
