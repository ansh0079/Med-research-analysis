...
interface StartReviewCardProps {
  startTopic: string;
  setStartTopic: (v: string) => void;
  startReview: (topicOverride?: string) => void;
  pendingStartTopic: string | null;
  activeRuns: NonNullable<LearningDashboard['activeRuns']>;
  navigate: NavigateFunction;
}

export const StartReviewCard: React.FC<StartReviewCardProps> = ({
  startTopic,
  setStartTopic,
  startReview,
  pendingStartTopic,
