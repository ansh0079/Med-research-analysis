...
import type { ReflectionKind } from '@components/case/CaseModeUtils';

export function CaseReflectionExportPanel({
  kind,
  saveStatus,
  onKindChange,
  onExport,
    ...
    <div className="rounded-xl border border-emerald-100 bg-emerald-50/70 p-4 dark:border-emerald-900/40 dark:bg-emerald-950/20">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <i className={`fas ${saveStatus === 'saving' ? 'fa-circle-notch fa-spin' : saveStatus === 'saved' ? 'fa-check' : 'fa-save'} text-[10px]`} />
