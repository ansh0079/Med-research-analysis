...
import { MemoryDetailBadge } from '@components/quiz/MemoryDetailBadge';
...
export const QuizPageHeader: React.FC<QuizPageHeaderProps> = ({
  activeTopic,
  lockedArticlesCount,
  singlePaperMode,
  fromDataset,
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          {lockedArticlesCount === 1 && singlePaperMode && (
          ...
          {lockedArticlesCount > 1 && (
            <span className="mt-1 inline-block text-[10px] font-bold uppercase tracking-widest text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/20 px-2 py-0.5 rounded-full">
              <i className="fas fa-layer-group mr-1" />
              Grounded in top {lockedArticlesCount} evidence papers from your search
            </span>
          )}
          {fromDataset && (
