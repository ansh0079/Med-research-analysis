...
const { registerAdminObservabilityRoutes } = require('./server/routes/admin/observability');
const { registerAdminCurriculumRoutes } = require('./server/routes/admin/curriculum');
...
registerAdminObservabilityRoutes(app, routeDeps);
registerAdminCurriculumRoutes(app, routeDeps);
